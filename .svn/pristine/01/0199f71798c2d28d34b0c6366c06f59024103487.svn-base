...
import cn.com.taiji.sample.manager.comm.handler.CommSampleServiceHandler;
import cn.com.taiji.sample.manager.comm.handler.MyFileCommHandleListener;
import cn.com.taiji.sample.manager.comm.handler.SampleServiceHandler;
import cn.com.taiji.sample.model.comm.FileProtocolError;
...
public class BinFileCommHandleManager extends AbstractHttpFileCommHandleManager implements HttpFileCommHandleManager
{
	...
	private Map<SampleServiceType, BinFileServiceHandler> handlers = Maps.newHashMap();
	@Autowired
			...
			throws ServiceHandleException
	{
		...
		SampleServiceType serviceType = SampleServiceType.fromName(strs[0]);
	...
	public void init()
	{
		...
		handlers.put(SampleServiceType.SAMPLE, sampleHandler);
		handlers.put(SampleServiceType.COMMSAMPLE, jsonSampleHandler);
	}
}
