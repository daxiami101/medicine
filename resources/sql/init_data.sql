...
commit;
delete from SAMPLE_UNIT;
commit;


INSERT INTO SAMPLE_UNIT (ID, LIST, NAME, CODE, UNIT_LEVEL,GLOBAL_LIST) values ('root', '1', '顶级单位', '0', '0','0');
commit;

Insert into SAMPLE_ROLE (ID,INFO,LIST,NAME,SYSTEM,UNIT_ID) values ('admin',null,1,'系统管理员',1,'root');
commit;
...
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl',4,'default.gif',null,'COLUMN','单位管理','A_XTGL','app/acl/unit/manage','GET');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_cx',1,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_查询','A_XTGL','app/acl/unit/manage','POST');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_add',2,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_添加','A_XTGL','app/acl/unit/add/{parentId}','GET');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_add_post',2,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_添加','A_XTGL','app/acl/unit/add','POST');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_mod',3,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_修改','A_XTGL','app/acl/unit/edit/{id}','GET');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_mod_post',3,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_修改','A_XTGL','app/acl/unit/edit','POST');
Insert into SAMPLE_RESOURCE (ID,LIST,LOGO_PIC,MENU_ID,MENU_TYPE,NAME,TYPE_CODE,URL,REQUEST_METHOD) values ('xtgl_dwgl_del_post',4,'default.gif','xtgl_dwgl','NOT_MENU','单位管理_删除','A_XTGL','app/acl/unit/delete/{id}','POST');
...
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl','xtgl_dwgl','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_cx','xtgl_dwgl_cx','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_add','xtgl_dwgl_add','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_add_post','xtgl_dwgl_add_post','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_mod','xtgl_dwgl_mod','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_mod_post','xtgl_dwgl_mod_post','admin');
Insert into SAMPLE_ROLE_RESOURCE (ID,RESOURCE_ID,ROLE_ID) values ('xtgl_dwgl_del_post','xtgl_dwgl_del_post','admin');
commit;