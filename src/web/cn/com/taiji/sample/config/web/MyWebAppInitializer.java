package cn.com.taiji.sample.config.web;
...
import cn.com.taiji.mycomm.web.sso.filter.SsoAuthFilter;
...
public class MyWebAppInitializer extends AbstractDispatcherServletInitializer
{
	...
	{
		// Web 应用根目录以该属性名(webapp.sample)添加到系统参数(System.property)中
		WebAppRootListener appRootListener = new WebAppRootListener();
		servletContext.setInitParameter("webAppRootKey", "webapp.sample");
	...
	protected Filter[] getServletFilters()
	{
		...
		return new Filter[] { encFilter, ssoFilter };
	}
