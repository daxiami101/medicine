...
@Controller
@RequestMapping("/medicine/harvest/taskSelect")
public class SourceHarvestSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceHarvestManager manager;
	private final String prefix = "medicine/harvest/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceHarvest req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceHarvest req, HttpServletResponse response, Model model,
