 ...
 */
@Controller
@RequestMapping("/enterprise/sales")
public class SourceEnterpriseSalesController extends BaseLogController
{
	@Autowired
	private SourceSoldManager manager;
	private final String prefix = "enterprise/sales/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceSoldPageRequest req, Model model, HttpServletRequest request)
	{
