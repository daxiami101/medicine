 ...
 */
@Controller
@RequestMapping("/land/diseaseCtrl")
public class SourceDiseaseCtrlController extends BaseLogController
{
	@Autowired
	private SourceDiseaseCtrlManager manager;
	@Autowired
	private SourceSeedManager seedManager;
	@Autowired
	private SourceFarmerManager farmerManager;
	private final String prefix = "land/diseaseCtrl/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceDiseaseCtrlPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel") SourceDiseaseCtrlPageRequest req,HttpServletRequest request, Model model)
	{
...
//		super.addSysLog(request, "删除角色({})成功", roleName);
	...
	public String view(@PathVariable("id") String id, Model model)
	{
		 ...
		 SourceDiseaseCtrl task = manager.findById(id);
