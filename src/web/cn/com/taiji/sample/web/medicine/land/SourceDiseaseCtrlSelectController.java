...
@Controller
@RequestMapping("/land/diseaseCtrl/taskSelect")
public class SourceDiseaseCtrlSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceDiseaseCtrlManager manager;
	private final String prefix = "land/diseaseCtrl/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceDiseaseCtrl req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceDiseaseCtrl req, HttpServletResponse response, Model model,
