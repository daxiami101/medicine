...
@Controller
@RequestMapping("/land/fertilization/taskSelect")
public class SourceFertilizationSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceFertilizationManager manager;
	private final String prefix = "land/fertilization/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceFertilization req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceFertilization req, HttpServletResponse response, Model model,
