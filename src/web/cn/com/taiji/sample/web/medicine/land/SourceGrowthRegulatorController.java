 ...
 */
@Controller
@RequestMapping("/land/growthRegulator")
public class SourceGrowthRegulatorController extends BaseLogController
{
	@Autowired
	private SourceGrowthRegulatorManager manager;
	@Autowired
	private SourceSeedManager seedManager;
	@Autowired
	private SourceFarmerManager farmerManager;
	private final String prefix = "land/growthRegulator/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceGrowthRegulatorPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel")SourceGrowthRegulatorPageRequest req,HttpServletRequest request, Model model)
	{
...
//		super.addSysLog(request, "删除角色({})成功", roleName);
	...
	public String view(@PathVariable("id") String id, Model model)
	{
		...
		SourceGrowthRegulator task = manager.findById(id);
