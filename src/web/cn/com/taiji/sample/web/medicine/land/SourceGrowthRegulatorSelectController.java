...
@Controller
@RequestMapping("/land/growthRegulator/taskSelect")
public class SourceGrowthRegulatorSelectController extends BaseLogController
{
	@Autowired
	...
	private final String prefix = "land/growthRegulator/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceGrowthRegulator req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceGrowthRegulator req, HttpServletResponse response, Model model,
