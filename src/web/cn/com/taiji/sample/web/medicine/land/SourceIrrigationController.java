 ...
 */
@Controller
@RequestMapping("/land/irrigation")
public class SourceIrrigationController extends BaseLogController
{
	@Autowired
	private SourceIrrigationManager manager;
	@Autowired
	private SourceSeedManager seedManager;
	@Autowired
	private SourceFarmerManager farmerManager;
	private final String prefix = "land/irrigation/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceIrrigationPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel") SourceIrrigationPageRequest req,HttpServletRequest request, Model model)
	{
...
//		super.addSysLog(request, "删除角色({})成功", roleName);
	...
	{
		SourceIrrigation task = manager.findById(id);
