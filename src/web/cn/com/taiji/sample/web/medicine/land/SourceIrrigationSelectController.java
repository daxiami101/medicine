...
@Controller
@RequestMapping("/land/irrigation/taskSelect")
public class SourceIrrigationSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceIrrigationManager manager;
	private final String prefix = "land/irrigation/taskSelect/";
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceIrrigationPageRequest req, Model model)
	{
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceIrrigationPageRequest req, HttpServletResponse response, Model model,
