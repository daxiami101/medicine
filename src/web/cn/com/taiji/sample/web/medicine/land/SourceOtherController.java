 ...
 */
@Controller
@RequestMapping("/land/other")
public class SourceOtherController extends BaseLogController
{
	@Autowired
	private SourceOtherManager manager;
	@Autowired
	private SourceSeedManager seedManager;
	@Autowired
	private SourceFarmerManager farmerManager;
	private final String prefix = "land/other/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceOtherPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel") SourceOtherPageRequest req,HttpServletRequest request, Model model)
	{
...
//		super.addSysLog(request, "删除角色({})成功", roleName);
	...
	public String view(@PathVariable("id") String id, Model model)
	{
		...
		SourceOther task = manager.findById(id);
