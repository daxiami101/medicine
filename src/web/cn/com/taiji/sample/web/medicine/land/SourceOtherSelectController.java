...
@Controller
@RequestMapping("/land/other/taskSelect")
public class SourceOtherSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceOtherManager manager;
	private final String prefix = "land/other/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceOther req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceOther req, HttpServletResponse response, Model model,
