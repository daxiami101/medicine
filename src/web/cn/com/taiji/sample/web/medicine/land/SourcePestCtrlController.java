 ...
 */
@Controller
@RequestMapping("/land/pestCtrl")
public class SourcePestCtrlController extends BaseLogController
{
	@Autowired
	...
	private final String prefix = "land/pestCtrl/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourcePestCtrlPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel") SourcePestCtrlPageRequest req,HttpServletRequest request, Model model)
	{
...
//		super.addSysLog(request, "删除角色({})成功", roleName);
	...
	public String view(@PathVariable("id") String id, Model model)
	{
		...
		SourcePestCtrl task = manager.findById(id);
