...
@Controller
@RequestMapping("/land/sowTransplant/taskSelect")
public class SourceSowTransplantSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceSowTransplantManager manager;
	private final String prefix = "land/sowTransplant/taskSelect/";
...
//		driManager.randomConfig(driModel, request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceSowTransplantPageRequest req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceSowTransplantPageRequest req, HttpServletResponse response, Model model,
