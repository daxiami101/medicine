...
@Controller
@RequestMapping("/land/weed/taskSelect")
public class SourceWeedSelectController extends BaseLogController
{
	@Autowired
	private SourcePlantTaskManager planTaskManager;
	@Autowired
	private SourceWeedManager manager;
	private final String prefix = "land/weed/taskSelect/";
...
//		manager.chooseTask(pageModel,request);
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceWeed req, Model model)
	{
...
//		planTaskManager.createPlanTask(seedId);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceWeed req, HttpServletResponse response, Model model,
