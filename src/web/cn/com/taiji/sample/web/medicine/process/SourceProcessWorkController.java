 ...
 */
@Controller
@RequestMapping("/process/processWork")
public class SourceProcessWorkController extends BaseLogController
{
	@Autowired
	...
	private final String prefix = "process/processWork/";
...
//		model.addAttribute("roles", roleManager.getAll(LoginHelper.getLoginUser(request)));
	...
	public String view(@PathVariable("id") String id, Model model)
	{
		...
		SourceProcess task = manager.findById(id);
