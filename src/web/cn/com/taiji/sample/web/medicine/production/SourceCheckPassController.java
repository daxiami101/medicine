...
import cn.com.taiji.sample.manager.medicine.produce.SourceCheckPassManager;
 ...
 */
@Controller
@RequestMapping("/tablet/materialCheckDischarge")
public class SourceCheckPassController extends BaseLogController
{
	@Autowired
	private SourceCheckPassManager manager;
	@Autowired
	private SourcePurchaseManager purchaseManager;
	private final String prefix = "tablet/materialCheckDischarge/";
