...
import cn.com.taiji.sample.manager.medicine.produce.SourcePrintLogManager;
 ...
 */
@Controller
@RequestMapping("/tablet/logPrint/")
public class SourceLogPrintController extends BaseLogController
{
	@Autowired
	private SourcePrintLogManager manager;
	private final String prefix = "tablet/logPrint//";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourcePrintLogPageRequest req, Model model, HttpServletRequest request)
	{
	...
	public String managePost(@Valid @ModelAttribute("queryModel") SourcePrintLogPageRequest req,HttpServletRequest request, Model model)
	{
