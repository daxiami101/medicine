...
@Controller
@RequestMapping("/tablet/medicine/taskSelect")
public class SourceMedicineStoreSelectController extends BaseLogController
{
	@Autowired
	...
	private final String prefix = "tablet/medicine/taskSelect/";
	...
	public String createTask(@PathVariable("id") String id,@ModelAttribute("pageModel") SourceMedicineStore req, Model model)
	{
...
//		System.out.println("findById:"+findById);
	...
	public String createTaskPost(@ModelAttribute("pageModel") SourceMedicineStore req, HttpServletResponse response, Model model,
