 ...
 */
@Controller
@RequestMapping("/endProduct/package")
public class SourceProductionPackageController extends BaseLogController
{
	@Autowired
	private SourceProductionManager manager;
	private final String prefix = "endProduct/package/";
