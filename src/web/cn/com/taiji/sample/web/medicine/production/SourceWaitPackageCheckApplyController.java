 ...
 */
@Controller
@RequestMapping("/waitPackage/checkApply")
public class SourceWaitPackageCheckApplyController extends BaseLogController
{
	@Autowired
	private SourceWaitPackageManager manager;
	private final String prefix = "waitPackage/checkApply/";

	@RequestMapping(value = "/manage", method = RequestMethod.GET)
	public String manageGet(@ModelAttribute("queryModel")SourceWaitPackagePageRequest req, Model model, HttpServletRequest request)
	{
