...
public class ZXingCode
{
    ...
    {  
        ...
        {  
            ...
            for(String medicineName:medicineNames){
            	String logoFilePath="C:/Users/dn/Desktop/二维码测试/furen.png";
            	String saveFilePath="C:/Users/dn/Desktop/二维码测试/二维码样例文件10个/"+medicineName+".png";
                getLogoQRCode("https://www.baidu.com/",logoFilePath,saveFilePath, medicineName);
            }
        }  
        catch (Exception e)  
        {  
     ...
     * @param logoPic
     */
    public static String getLogoQRCode(String qrUrl,String logoFilePath,String saveFilePath,String productName)
    {
//      String filePath = (javax.servlet.http.HttpServletRequest)request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        //logoFilePath是二维码logo的路径，但是实际中我们是放在项目的某个路径下面的，所以路径用上面的，把下面的注释就好
//        logoFilePath = "C:/Users/dn/Desktop/二维码测试/furen.png";  //TODO  
//        C:\Users\dn\Desktop\二维码测试
        ...
        {  
            ...
            return zp.addLogo_QRCode(bim, new File(logoFilePath), new LogoConfig(),saveFilePath, productName);
        }
        catch (Exception e)
        {
            e.printStackTrace();
     ...
     * @param logoPic
     */
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig,String saveFilePath, String productName)
    {
        try
        {
            /**
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            ImageIO.write(image, "png", new File(saveFilePath)); //TODO  
