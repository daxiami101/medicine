...
<div class="modal-header">
	...
	<h4 class="modal-title">选择封装信息</h4>
</div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div id="userSelectManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">选择待封装信息</h4>
                        </div>
                        
                        <div class="panel-toolbar ">
                        	
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/endProduct/out/taskSelect/manage" method="post">
