				...
				<div class="col-md-12">
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">运输管理</h4>
						</div>

						<div class="panel-toolbar">
						<a href="${rootUrl }app/medicine/transport/taskSelect/manage"  class="taiji_modal_lg  btn  btn-success m-r-10">
					添加任务
					</a>
							<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel" 
							id="listForm" name="listForm" 
							action="${rootUrl}app/enterprise/transport/manage" method="post">
								<!-- 查询条件 -->
...
<!-- 								</div> -->
								<div class="form-group m-5" id="data-table_length" style="position:relative;">
									<label class="control-label">平台名称（汉字）</label>
								...
								<button class="taiji_search_submit btn btn-md btn-success m-r-5" type="button" id="queryButton">
									...
									<a href="${rootUrl}app/info/infoServiceInfoUser/add" class="taiji_modal  btn  btn-success m-r-10">
										<i class="fa fa-plus m-r-5"></i>添加权限
									</a>
									<a href="${rootUrl}app/info/infoServiceInfoUser/infoServiceUser/add" class="taiji_modal  btn  btn-success m-r-10">
										<i class="fa fa-plus m-r-5"></i>添加用户
									</a>
									<a href="${rootUrl}app/info/infoServiceInfoUser/infoServiceInfo/add" class="taiji_modal  btn  btn-success m-r-10">
										<i class="fa fa-plus m-r-5"></i>添加接口
									</a>
									...
									<div id="special" style="display:none">
										<a href="${rootUrl}app/info/infoServiceInfoUser/gpsReset" confirm_message="确定要重置吗?" class="taiji_modal  btn  btn-success taiji_remove  taiji_acl">
										<i class=" m-r-5"></i>GPS开关重置
									</a>
									</div>
							</form:form>
						</div>
