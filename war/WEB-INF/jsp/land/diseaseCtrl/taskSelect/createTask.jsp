...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/land/diseaseCtrl/taskSelect/createTask" method="post">
...
<!-- 	    <label  class="col-sm-2 control-label">种子批号</label> -->
	  ...
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">主要病害种类</label>
	    <div class="col-sm-10">
	    	<form:input path="diseaseKind"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">危害部位</label>
	    <div class="col-sm-10">
	    	<form:input path="diseasePalce"  cssClass="form-control" />
	    </div>
	  </div>
	<div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path="drugKind"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
