...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/land/fertilization/taskSelect/createTask" method="post">
...
<!-- 	    <label  class="col-sm-2 control-label">种子批号</label> -->
	  ...
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">肥料种类</label>
	    <div class="col-sm-10">
	    	<form:input path="fertilitizationKind"  cssClass="form-control" />
	    </div>
	  </div>
	<div class="form-group">
		<label  class="col-sm-2 control-label">施肥开始时间：</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="fertStartTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('fertStartTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
	   <div class="form-group">
		<label  class="col-sm-2 control-label">施肥结束时间：</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="fertEndTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('fertEndTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">施肥方式</label>
	    <div class="col-sm-10">
	    	<form:input path="fertMethod"  cssClass="form-control"/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">施肥量/亩</label>
	    <div class="col-sm-10">
	    	<form:input path="fertNum"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
