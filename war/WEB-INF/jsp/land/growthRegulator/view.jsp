	 	...
	 	<div class="modal-body">
		  	<table class="table table-bordered">
		  	 <tr style="background:#f0f3f5">
				...
				<tr>
					<th>生长调节剂种类 </th>
					<td>${fn:escapeXml(model.regulatorKind) }</td>
					<th>种植药材</th>
				...
				<tr>
					...
					<td></td>
					<th>施用开始时间</th>
					<td><fmt:formatDate value="${model.useStartTime.time}" pattern="yyyy-MM-dd"/></td>
				</tr>
				<tr>
					<th>施用结束时间 </th>
					<td><fmt:formatDate value="${model.useEndTime.time}" pattern="yyyy-MM-dd"/></td>
					<th>施用方式</th>
					<td>${fn:escapeXml(model.useMethod) }</td>
				</tr>
				<tr>
					<th>用药量/亩</th>
