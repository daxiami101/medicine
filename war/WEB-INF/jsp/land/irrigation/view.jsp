		  	...
		  	<table class="table table-bordered">
		  	 <tr style="background:#f0f3f5">
				...
				<tr>
					...
					<th>灌溉方式</th>
					<td>${fn:escapeXml(model.method) }</td>
				</tr>
				<tr>
					<th>灌溉开始时间</th>
					<td><fmt:formatDate value="${model.irrigationStartTime.time}" pattern="yyyy-MM-dd"/></td>
					<th>灌溉结束时间</th>
					<td><fmt:formatDate value="${model.irrigationEndTime.time}" pattern="yyyy-MM-dd"/></td>
				</tr>
				<tr style="background:#f0f3f5">
