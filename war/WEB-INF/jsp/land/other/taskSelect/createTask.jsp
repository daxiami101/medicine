...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/land/other/taskSelect/createTask" method="post">
...
<!-- 	    <label  class="col-sm-2 control-label">种子批号</label> -->
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path="operation"  cssClass="form-control" />
	    </div>
	  </div>
	<div class="form-group">
		<label  class="col-sm-2 control-label">开始时间 ：</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="operationStartTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('operationStartTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
	   <div class="form-group">
		...
		<div class="input-group" style="width:130px">
	    	<form:input  path="operationEndTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('operationEndTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
   </form:form> 
