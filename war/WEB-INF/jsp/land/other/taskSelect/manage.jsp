			    ...
			    <div class="col-md-12">
                    ...
                    <div id="userSelectManage" class="panel panel-inverse">
                        ...
                        <div class="panel-toolbar ">
                        	...
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/land/other/taskSelect/manage" method="post">
