	 	...
	 	<div class="modal-body">
		  	<table class="table table-bordered">
		  	 <tr style="background:#f0f3f5">
				...
				<tr>
					<th>操作 </th>
					<td>${fn:escapeXml(model.operation) }</td>
					<th>种植药材</th>
					<td>${fn:escapeXml(model.medicineName) }</td>
				</tr>
				<tr>
					<th>开始时间</th>
					<td><fmt:formatDate value="${model.operationStartTime.time}" pattern="yyyy-MM-dd"/></td>
					<th>结束时间 </th>
					<td><fmt:formatDate value="${model.operationEndTime.time}" pattern="yyyy-MM-dd"/></td>
				</tr>
				<tr style="background:#f0f3f5">
