...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/land/pestCtrl/taskSelect/createTask" method="post">
...
<!-- 	    <label  class="col-sm-2 control-label">种子批号</label> -->
	  ...
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">主要虫害种类</label>
	    <div class="col-sm-10">
	    	<form:input path="pestKind"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">危害部位</label>
	    <div class="col-sm-10">
	    	<form:input path="pestPlace"  cssClass="form-control" />
	    </div>
	  </div>
	<div class="form-group">
		<label  class="col-sm-2 control-label">防治开始时间 ：</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="preventStartTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('preventStartTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
	   <div class="form-group">
		<label  class="col-sm-2 control-label">防治结束时间：</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="preventEndTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('preventEndTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">防治方式</label>
	    <div class="col-sm-10">
	    	<form:input path="preventMethod"  cssClass="form-control"/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">农药种类 </label>
	    <div class="col-sm-10">
	    	<form:input path="pesticideKind"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
	 ...
	 <div class="form-group">
	    <label  class="col-sm-2 control-label">农药采购人员</label>
	    <div class="col-sm-10">
	    	<form:input path="purchasePersonName"  cssClass="form-control" />
	    </div>
	  </div>
   </form:form> 
</div>
