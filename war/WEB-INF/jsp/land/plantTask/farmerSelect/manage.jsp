...
// 		$("#logManage").triggerHandler("taijiModalPost",[$("#listForm"),{table:"add"}]);
		$("#logManage").triggerHandler("taijiModalPost",[$("#randomForm"),{table:"add"}]);
			    ...
			    <div class="col-md-12">
                    ...
                    <div id="userSelectManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">选择农户</h4>
                        </div>
                        
                        <div class="panel-toolbar ">
                        	
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="pageModel"  id="listForm" name="listForm" action="${rootUrl}app/land/plantTask/farmerSelect/manage" method="post">
<%-- 								<form:input path="taskId" value="${taskId}"/> --%>
								<label class="control-label">农户名称</label>
								<div class="form-group m-5">
									<form:input path="" size="25" maxlength="50" cssClass="form-control"/>
								</div>
<!-- 								<div class="form-group m-5"> -->
...
<!-- 								</div> -->
					...
					<div  class="collapse" id="collapse-content-inner" >
             		  ...
             		  <div style="margin:-20px 20px 5px 20px">
		 					<form:form modelAttribute="pageModel"  id="randomForm" name="randomForm" method="post" action="${rootUrl }app/land/plantTask/farmerSelect/randomConfig">
