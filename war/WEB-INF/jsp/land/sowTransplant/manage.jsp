				...
				<div class="col-md-12">
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">播种移栽</h4>
						</div>

						<div class="panel-toolbar">
						<a href="${rootUrl }app/land/sowTransplant/taskSelect/manage"  class="taiji_modal_lg  btn  btn-success m-r-10">
					添加任务
					</a>
							<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel" 
							id="listForm" name="listForm" 
							action="${rootUrl}app/land/sowTransplant/manage" method="post">
								<!-- 查询条件 -->
					...
					<div  class="collapse" id="collapse-content" >
						<div class="form-group m-t-5">	
									<label class="control-label">种植类型</label>
