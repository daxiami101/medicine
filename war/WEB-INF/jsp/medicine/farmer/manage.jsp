		...
		<div class="row">
			...
			<div id="logManage" class="panel panel-inverse">
				<div class="panel-heading">
                            ...
                            <h4 class="panel-title">农户档案管理</h4>
                        </div>
                        
                  <div class="panel-toolbar">
                  		<a href="${rootUrl }app/medicine/farmer/add"  class="taiji_modal	btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>添加</a>
...
<!-- 						</a> -->
				...
				<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/medicine/farmer/manage" method="post" enctype="multipart/form-data">
				<!-- 查询条件 -->
					<div class="taiji_search_condition  m-t-5">
					</div>
					<div class="form-group m-t-5">
							<label class="control-label">农户代码</label>
							<form:input path="farmerNo" cssClass="form-control" maxlength="50" />
						</div>
						<div class="form-group m-t-5">	
...
<%-- 								<form:option value="">全部</form:option> --%>
<%-- 								<form:options items="${provinces}" itemLabel="provinceName"/> --%>
<%-- 							</form:select> --%>
<!-- 						</div>	 -->
...
<!-- 	 				</div>	 -->
					...
					<div  class="collapse" id="collapse-content" >
						<div class="form-group m-t-5">
							...
							<label class="control-label">种植合同号</label>
							<form:input path="contractNum" cssClass="form-control" maxlength="50" />
						</div>	
