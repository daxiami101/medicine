				...
				<div class="col-md-12">
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">采收管理</h4>
						</div>

						<div class="panel-toolbar">
						<a href="${rootUrl }app/medicine/harvest/taskSelect/manage"  class="taiji_modal_lg  btn  btn-success m-r-10">
					添加任务
					</a>
							<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel" 
							id="listForm" name="listForm" 
							action="${rootUrl}app/medicine/harvest/manage" method="post">
								<!-- 查询条件 -->
