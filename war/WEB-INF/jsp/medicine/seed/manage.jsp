		...
		<div class="row">
			...
			<div id="logManage" class="panel panel-inverse">
				<div class="panel-heading">
                            ...
                            <h4 class="panel-title">种源管理</h4>
                        </div>
                        
                  <div class="panel-toolbar">
                  <a href="${rootUrl }app/medicine/seed/add"  class="taiji_modal	btn  btn-success m-5"><i class="fa fa-plus m-r-5"></i>添加</a>
...
<!-- 						</a> -->
				...
				<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/medicine/seed/manage" method="post" enctype="multipart/form-data">
				<!-- 查询条件 -->
					<div class="taiji_search_condition  m-t-5">
					</div>
					<div class="form-group m-t-5">
							<label class="control-label">种子批号</label>
							<form:input path="seedNo" cssClass="form-control" maxlength="50" />
						</div>
					<div class="form-group m-t-5">
							<label class="control-label">药材名称</label>
							<form:input path="medicineId" cssClass="form-control" maxlength="50" />
						</div>
					<div class="form-group m-t-5">
							<label class="control-label">拉丁名</label>
							<form:input path="latinName" cssClass="form-control" maxlength="50" />
						</div>
						<div class="form-group m-t-5">	
							<label class="control-label">繁殖材料</label>
					...
					<div  class="collapse" id="collapse-content" >
			            <div class="form-group m-t-5">	
							<label class="control-label">繁殖方式</label>
						...
						<div class="form-group m-t-5">	
							<label class="control-label">繁殖地点</label>
