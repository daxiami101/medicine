			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					添加任务
							...
							action="${rootUrl}app/medicine/storage/manage" method="post">
								<!-- 查询条件 -->
...
<!-- 								</div> -->
								<div class="form-group m-5" id="data-table_length" style="position:relative;">
									<label class="control-label">储存仓库代码</label>
									<form:input path="storeCode" class="form-control" size="10" maxlength="40" />
								</div>
