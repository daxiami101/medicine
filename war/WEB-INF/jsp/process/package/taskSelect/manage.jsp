...
<div class="modal-header">
	...
	<h4 class="modal-title">选择检验信息</h4>
</div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div id="userSelectManage" class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">选择检验信息</h4>
                        </div>
                        
                        <div class="panel-toolbar ">
                        	
                        	<form:form cssClass="taiji_search_form form-inline m-t-5 " modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/process/package/taskSelect/manage" method="post">
<%-- 								<form:input path="taskId" value="${taskId}"/> --%>
								<label class="control-label">采收批号</label>
								<div class="form-group m-5">
									<form:input path="harvestNo" size="25" maxlength="50" cssClass="form-control"/>
								</div>
<!-- 								<div class="form-group m-5"> -->
