				...
				<div class="col-md-12">
					<div id="myManage" class="panel panel-inverse">
						<div class="panel-heading">
							...
							<h4 class="panel-title">加工</h4>
						</div>

						<div class="panel-toolbar">
						<a href="${rootUrl }app/process/processWork/taskSelect/manage"  class="taiji_modal_lg  btn  btn-success m-r-10">
					添加任务
					</a>
							<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel" 
							id="listForm" name="listForm" 
							action="${rootUrl}app/process/processWork/manage" method="post">
								<!-- 查询条件 -->
...
<!-- 								</div> -->
								<div class="form-group m-5" id="data-table_length" style="position:relative;">
									...
									<form:input path="harvestNo" class="form-control" size="10" maxlength="40" />
								</div>
