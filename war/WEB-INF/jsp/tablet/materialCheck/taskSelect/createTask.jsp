...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/tablet/materialCheck/taskSelect/createTask" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path=""  cssClass="form-control" readonly="true" value="${model.taskNo }"/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">采收批号</label>
	    <div class="col-sm-10">
	    	<form:input path=""  cssClass="form-control" readonly="true" value="${model.harvestNo }"/>
	    </div>
	  </div>
	  <div class="form-group">
