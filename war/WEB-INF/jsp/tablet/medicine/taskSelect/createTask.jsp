...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/tablet/medicine/taskSelect/createTask" method="post">
	  <div class="form-group">
<!-- 	    <label  class="col-sm-2 control-label">种子批号</label> -->
	    <div class="col-sm-10">
	    	<form:input path="purchaseId" type="hidden" cssClass="form-control" placeholder=""  value="${task.id }"/>
	    </div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path="originalPlace"  cssClass="form-control"  />
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">物料批号</label>
	    <div class="col-sm-10">
	    	<form:input path="materialId"  cssClass="form-control"  />
	    </div>
	  </div>
	  <div class="form-group">
...
<%-- 	    	<form:input  path=""  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/> --%>
