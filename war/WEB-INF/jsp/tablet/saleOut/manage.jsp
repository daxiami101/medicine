		...
		<div class="row">
			...
			<div id="myManage" class="panel panel-inverse">
				<div class="panel-heading">
                            ...
                            <h4 class="panel-title">销售出库</h4>
                        </div>
                        
                  <div class="panel-toolbar">
                  <a href="${rootUrl }app/tablet/saleOut/taskSelect/manage"  class="taiji_modal_lg  btn  btn-success m-r-10">
					添加任务
					</a>
...
<!-- 						</a> -->
				...
				<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/tablet/saleOut/manage" method="post" enctype="multipart/form-data">
				<!-- 查询条件 -->
