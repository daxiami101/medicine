...
<!-- 						</a> -->
				...
				<form:form cssClass="taiji_search_form form-inline m-t-5" modelAttribute="queryModel"  id="listForm" name="listForm" action="${rootUrl}app/waitPackage/check/manage" method="post" enctype="multipart/form-data">
				<!-- 查询条件 -->
...
<!-- 	 				</div>	 -->
	 				...
	 				<div class="form-group m-t-5">
						...
						<div  class="input-group">
							...
							<form:input path="" cssClass="form-control"   size="10" maxlength="50" />
							<span class="input-group-btn">
					...
					<div  class="collapse" id="collapse-content" >
						<div class="form-group m-t-5">	
									<label class="control-label">待分装状态</label>
										<form:select path="packageStatus" cssClass="form-control" >
										<form:option value="">全部</form:option>
										<form:options items="${packageStatuses}" itemLabel="value"/>
										</form:select>
								</div>
						<div class="form-group m-t-5">
