...
<div class="modal-body">
	<form:form modelAttribute="pageModel" id="myForm" name="myForm" cssClass="form-horizontal" action="${rootUrl}app/waitPackage/package/taskSelect/createTask" method="post">
...
<!-- <!-- 	    </div> -->
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path="produceName"  cssClass="form-control" readonly="true" value="${task.purchaseId }"/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">产地</label>
	    <div class="col-sm-10">
	    	<form:input path="originalPlace"  cssClass="form-control"  value=""/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">产品批号</label>
	    <div class="col-sm-10">
	    	<form:input path="productionId"  cssClass="form-control"  value=""/>
	    </div>
	  </div>
	  <div class="form-group">
	    <label  class="col-sm-2 control-label">产品名称</label>
	    <div class="col-sm-10">
	    	<form:input path="produceName"  cssClass="form-control" />
	    </div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	    	<form:input path="comcode"  cssClass="form-control"  />
	    </div>
	  </div>
	  <div class="form-group">
		<label  class="col-sm-2 control-label">分装日期</label>
		<div class="input-group" style="width:130px">
	    	<form:input  path="packageTime"  cssStyle="width:150px" cssClass="form-control" placeholder="必填"/>
		    <span class="input-group-btn">
				<button type="button" class="btn btn-default" onclick="WdatePicker({el:$dp.$('packageTime'),dateFmt:'yyyy-MM-dd HH:mm:00'});"><i class="fa fa-calendar"></i></button>
			</span>
		</div>
	</div>
   </form:form> 
