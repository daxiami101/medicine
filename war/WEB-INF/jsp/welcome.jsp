...
<body>
<div id="login_bg" class ="login_bg" style="background-image:url(${rootUrl }images/u3.jpg);"></div>
<!-- begin #page-loader -->
<!-- 	<div id="page-loader" class="fade in"><span class="spinner"></span></div> -->
	...
	<div id="page-container" class="login-container">
        ...
        <div class="login  animated">
        	...
        	<h1 id="logo">本草真源</h1>
			<h2 id="subheading">河南辅仁堂制药有限公司</h2>
        </div>
            <!-- end brand -->
...
<%--                 	<a id="tplogin"  href="${oauthUrl}" class="btn btn-link btn-sm ">第三方登录</a> --%>
        ...
        <!-- end login -->
        <div class="myfooter"style="align:left">
    	<div class="myfooter_signup_link" >
        	<a class="mysignup_link" href="${rootUrl }app/common/register">注册</a>
<!--             <a href="https://www.baidu.com" target="_blank" class="mylink unnamed_1">Patent</a> -->
<!--             <a href="#" target="_blank" class="mylink unnamed_2">About</a> -->
        </div>
